...
const Prism = (e => {
    ...
    const r = {};
    const a = {
        manual: e.Prism?.manual,
        disableWorkerMessageHandler: e.Prism?.disableWorkerMessageHandler,
        util: {
            encode: function e(n) {
            ...
            type: e => Object.prototype.toString.call(e).slice(8, -1),
            objId: e => (e.__id || Object.defineProperty(e, '__id', { value: ++t }), e.__id),
        ...
        highlightAllUnder: (e, n, t) => {
            ...
            for (let i, l = 0; (i = r.elements[l++]); ) a.highlightElement(i, !0 === n, r.callback);
        },
        highlightElement: (n, t, r) => {
            ...
            if (
                ...
                return a.hooks.run('complete', s), void r?.call(s.element);
        ...
        tokenize: (e, n) => {
            ...
            return (
                ...
                o(e, a, n, a.head, 0),
                (e => {
                    for (let n = [], t = e.head.next; t !== e.tail; ) n.push(t.value), (t = t.next);
                    return n;
                })(a)
            );
        },
        hooks: {
            ...
            run: (e, n) => {
                ...
                if (t?.length) for (let r, i = 0; (r = t[i++]); ) r(n);
            }
        },
        Token: i
    };
...
!(e => {
    function n(e, n) {
        return e.replace(/<<(\d+)>>/g, (e, s) => `(?:${n[+s]})`);
    }
    function s(e, s, a) {
        return RegExp(n(e, s), a || '');
    }
    function a(e, n) {
        for (let s = 0; s < n; s++) e = e.replace(/<<self>>/g, () => `(?:${e})`);
...
(Prism.languages.c = Prism.languages.extend('clike', {
    ...
    (Prism.languages.c.boolean = undefined);
!(e => {
    const t =
    ...
    const n = '\\b(?!<keyword>)\\w+(?:\\s*\\.\\s*\\w+)*\\b'.replace(/<keyword>/g, () => t.source);
...
!(e => {
    ...
    (e.languages.coffeescript = e.languages.extend('javascript', {
        ...
        (e.languages.coffeescript['template-string'] = undefined),
...
!(e => {
    ...
    const r = '"(?:[^"\\\\\r\n]|\\\\(?:\r\n|[^]))*"|\'(?:[^\'\\\\\r\n]|\\\\(?:\r\n|[^]))*\'';
    const t = '--[\\w-]+=(?:<STR>|(?!["\'])(?:[^\\s\\\\]|\\\\.)+)'.replace(/<STR>/g, () => r);
    const o = { pattern: RegExp(r), greedy: !0 };
    const i = { pattern: /(^[ \t]*)#.*/m, lookbehind: !0, greedy: !0 };
    function a(e, r) {
        return (e = e.replace(/<OPT>/g, () => t).replace(/<SP>/g, () => n)), RegExp(e, r);
    }
    (e.languages.docker = {
        instruction: {
            pattern:
...
(Prism.languages.go = Prism.languages.extend('clike', {
    ...
    (Prism.languages.go['class-name'] = undefined);
(Prism.languages.graphql = {
    ...
    Prism.hooks.add('after-tokenize', n => {
        if ('graphql' === n.language)
            for (
                let t = n.tokens.filter(
                        n => 'string' !== typeof n && 'comment' !== n.type && 'scalar' !== n.type
                    ),
                    e = 0;
                e < t.length;
            ) {
        ...
        buildPlaceholders: {
            value: (t, a, r, o) => {
                if (t.language === a) {
                    ...
                    (t.code = t.code.replace(r, e => {
                        if ('function' === typeof o && !o(e)) return e;
                        for (let r, i = c.length; -1 !== t.code.indexOf((r = n(a, i))); ) ++i;
                        return (c[i] = e), r;
                    })),
                    ...
                    !(function c(i) {
                        for (let u = 0; u < i.length && !(r >= o.length); u++) {
                            ...
                            if (
                                ...
                                const f = 'string' === typeof g ? g : g.content;
                                const p = n(a, l);
                                const k = f.indexOf(p);
                                if (k > -1) {
                                    ++r;
...
!(n => {
    (n.languages.kotlin = n.languages.extend('clike', {
        ...
        (n.languages.kotlin['class-name'] = undefined);
    const e = {
        'interpolation-punctuation': { pattern: /^\$\{?|\}$/, alias: 'punctuation' },
    ...
    n.languages.insertBefore('kotlin', 'string', {
        ...
        (n.languages.kotlin.string = undefined),
...
!(n => {
    ...
    (n.languages.markdown = n.languages.extend('markup', {})),
        ...
        ['url', 'bold', 'italic', 'strike'].forEach(e => {
            ['url', 'bold', 'italic', 'strike', 'code-snippet'].forEach(t => {
                e !== t &&
                    (n.languages.markdown[e].inside.content.inside[t] = n.languages.markdown[t]);
            });
        }),
        n.hooks.add('after-tokenize', n => {
                            ...
                            if ('code' === i.type) {
                                ...
                                if (
                                    ...
                                    let l = r.content
                                        .replace(/\b#/g, 'sharp')
                                        .replace(/\b\+\+/g, 'pp');
                                    const s = `language-${(l = (/[a-z][\w-]*/i.exec(l) || [''])[0].toLowerCase())}`;
                                    o.alias
        ...
        n.hooks.add('wrap', e => {
            if ('code-block' === e.type) {
                for (let t = '', a = 0, i = e.classes.length; a < i; a++) {
                    const s = e.classes[a];
                    const d = /language-(.+)/.exec(s);
                    if (d) {
                        t = d[1];
                        break;
                    }
                }
                const p = n.languages[t];
                if (p)
                    e.content = n.highlight(
                        e.content
                            .replace(r, '')
                            .replace(/&(\w{1,8}|#x?[\da-f]{1,8});/gi, (n, e) => {
                                let t;
                    ...
                    const u = `md-${new Date().valueOf()}-${Math.floor(1e16 * Math.random())}`;
                    (e.attributes.id = u),
                        n.plugins.autoloader.loadLanguages(t, () => {
    ...
    const r = RegExp(n.languages.markup.tag.pattern.source, 'gi');
    const o = { amp: '&', lt: '<', gt: '>', quot: '"' };
    const l = String.fromCodePoint || String.fromCharCode;
...
!(e => {
    const i = (e.languages.powershell = {
        comment: [
            { pattern: /(^|[^`])<#[\s\S]*?#>/, lookbehind: !0 },
...
!(e => {
    ...
    e.languages.ruby.function = undefined;
    const t = `(?:${[
        '([^a-zA-Z0-9\\s{(\\[<=])(?:(?!\\1)[^\\\\]|\\\\[^])*\\1',
        '\\((?:[^()\\\\]|\\\\[^]|\\((?:[^()\\\\]|\\\\[^])*\\))*\\)',
        '\\{(?:[^{}\\\\]|\\\\[^]|\\{(?:[^{}\\\\]|\\\\[^])*\\})*\\}',
    ...
    e.languages.insertBefore('ruby', 'keyword', {
        ...
        (e.languages.ruby.string = undefined),
...
!(e => {
    for (let a = '/\\*(?:[^*/]|\\*(?!/)|/(?!\\*)|<self>)*\\*/', t = 0; t < 2; t++)
        a = a.replace(/<self>/g, () => a);
    (a = a.replace(/<self>/g, () => '[^\\s\\S]')),
        (e.languages.rust = {
            comment: [
...
!(e => {
    (e.languages.sass = e.languages.extend('css', {
        ...
        (e.languages.sass.atrule = undefined);
    const r = /\$[-\w]+|#\{\$[-\w]+\}/;
    const t = [
        /[+*\/%]|[=!]=|<=?|>=?|\b(?:and|not|or)\b/,
        { pattern: /(\s)-(?=\s)/, lookbehind: !0 }
    ...
    e.languages.insertBefore('sass', 'property', {
        ...
        (e.languages.sass.property = undefined),
        (e.languages.sass.important = undefined),
...
!(e => {
    (e.languages.typescript = e.languages.extend('javascript', {
        ...
        (e.languages.typescript.parameter = undefined),
        (e.languages.typescript['literal-property'] = undefined);
...
!(() => {
    if ('undefined' !== typeof Prism && 'undefined' !== typeof document && document.querySelector) {
        ...
        const i = 'linkable-line-numbers';
        const n = /\n(?!$)/g;
        let r = !0;
        Prism.plugins.lineHighlight = {
            highlightLines: (o, u, c) => {
                const h = (u = 'string' === typeof u ? u : o.getAttribute('data-line') || '')
                    .replace(/\s+/g, '')
                    .split(',')
                    .filter(Boolean);
                ...
                if (p && Prism.util.isActive(o, i) && P) {
                    ...
                    const E = Number.parseInt(o.getAttribute('data-start') || '1');
                    s('.line-numbers-rows > span', o).forEach((e, t) => {
                        const i = t + E;
                        e.onclick = () => {
                            const e = `${P}.${i}`;
                            (r = !1),
        ...
        let o = 0;
        Prism.hooks.add('before-sanity-check', e => {
            const t = e.element.parentElement;
            if (u(t)) {
                let i = 0;
                s('.line-highlight', t).forEach(e => {
            ...
            window.addEventListener('resize', () => {
                s('pre')
                    .filter(u)
                    .map(e => Prism.plugins.lineHighlight.highlightLines(e))
                    .forEach(a);
            });
    }
    function s(e, t) {
    ...
    function c() {
        ...
        s('.temporary.line-highlight').forEach(e => {
            e.parentNode.removeChild(e);
        });
        const t = (e.match(/\.([\d,-]+)$/) || [undefined, ''])[1];
        ...
        const t = (Prism.plugins.lineNumbers = {
            getLine: (n, t) => {
                if ('PRE' === n.tagName && n.classList.contains(e)) {
                    ...
                    if (i) {
                        const r = Number.parseInt(n.getAttribute('data-start'), 10) || 1;
                    ...
                    if (
                        ...
                        (l = document.createElement('span')).setAttribute('aria-hidden', 'true'),
                            ...
                            s.hasAttribute('data-start') &&
                                (s.style.counterReset = `linenumber ${Number.parseInt(s.getAttribute('data-start'), 10) - 1}`),
    ...
    function r(e) {
        if (
            ...
            t.forEach(e => {
                ...
                t.forEach(e => {
                    for (let n = e.sizer, t = e.lineHeights, i = 0, r = 0; r < t.length; r++)
...
!(() => {
    if ('undefined' !== typeof Prism && 'undefined' !== typeof document) {
        ...
        const a = (Prism.plugins.toolbar.registerButton = (n, a) => {
            let r;
            (r =
                'function' === typeof a
                    ? a
        ...
        const r = (Prism.plugins.toolbar.hook = a => {
...
!(() => {
    ...
    'undefined' !== typeof Prism &&
        ...
        (Prism.plugins.toolbar
            ? Prism.plugins.toolbar.registerButton('copy-to-clipboard', e => {
                  const o = e.element;
                  const n = (t => {
                      const e = {
                          copy: 'Copy',
                      ...
                      for (const o in e) {
                          for (let n = `data-prismjs-${o}`, c = t; c && !c.hasAttribute(n); )
                              c = c.parentElement;
