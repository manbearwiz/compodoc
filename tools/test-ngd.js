...
const ngdC = require('@compodoc/ngd-compiler');
const ngdCr = require('@compodoc/ngd-core');

const files = [
    '/Volumes/Data/wamp/Projets/open-source/compodoc/compodoc-demo-todomvc-angular2/src/app/about/about-routing.module.ts',
...
const compiler = new ngdC.Compiler(files, {
    tsconfigDirectory: process.cwd()
});

const deps = compiler.getDependencies();

const engine = new ngdT.DotEngine({
    output: 'test',
    displayLegend: true,
